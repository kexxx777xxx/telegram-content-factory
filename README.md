...
Фаза 1 з 10. Працює: база зі схемою й міграціями, конфіг, авторизація адмінки з перемикачем,
CRUD проєктів із шифрованими бот-токенами, перевірка підключення каналу, збірка й запуск у docker.
Генерації та публікації ще немає — це фази 2–7.
