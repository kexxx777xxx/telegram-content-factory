...
за собою і показує здоров'я на дашборді. 92 тести, зокрема навантажувальний прогін на 50 проєктах
і відновлення обірваної публікації.
...
npm test             # 92 тести (потрібен docker compose up -d db)
npm run typecheck
npm run seed:demo
```
