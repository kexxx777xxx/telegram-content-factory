...
- Не пиши хештеги. Їх дописує система своїм списком ({{hashtags}}) — твої були б
  другим рядком тегів у тому самому пості.
- Не більше {{maxChars}} символів. Це не побажання: довший текст відхиляється
  цілком, і пост доводиться писати заново.
